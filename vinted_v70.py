#!/usr/bin/env python3
# VERSION : VINTED_V710_BANGER_EXPRESS_FIX_NOTIFICATIONS
#
# Surcouche V6.9 :
...
vt.appliquer_exemples = appliquer_exemples_v78
...
if __name__ == "__main__":
    print("Vinted V7.10 — BANGER EXPRESS + notifications fiables + FLASH RECENT + triage confiance")
    try:
        asyncio.run(vt.main())
