#!/usr/bin/env python3
# VERSION : VINTED_V77_FASTPATH_CONFIANCE
#
# Surcouche V6.9 :
...
vt.scan_search = scan_search_v77
vt.appliquer_exemples = appliquer_exemples_v77
vt.verify_listing = verify_listing_v77
vt.append_alert = append_alert_v77
vt.ntfy_send = ntfy_send_v77


if __name__ == "__main__":
    print("Vinted V7.7 — FASTPATH + confiance + revente prudente + vision a la demande")
    try:
        asyncio.run(vt.main())
